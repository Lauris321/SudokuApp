...
class DailySudokuListDelete extends Component {
  constructor(props) {
    super(props);
  }
...
DailySudokuListDelete.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(DailySudokuListDelete);